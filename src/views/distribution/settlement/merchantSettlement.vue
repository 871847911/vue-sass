<template>
  <div class="app-container">
    ...
    <div class="zucheng">
      ...
      <div class="inputBox"><el-input v-model="formData" placeholder="商户账号"></el-input></div>
    </div>
    <div class="table">
  ...
  methods: {
    ...
    getCatalogPage(page = 1, pageSize) {
      ...
      let data = {
        ...
        name:this.formData?this.formData:null,
        userType : 2
      };
      self.loading = true;
      
      api.settlementTotalList(data).then(res => {
        console.log(res)
        self.loading = false;
    ...
    //详情
    handleClick(val) {
      this.$router.push({ name: "merchantSettlementDetails",query: { id: val.userId,name:val.name } });
    }
  }
};
</script>
